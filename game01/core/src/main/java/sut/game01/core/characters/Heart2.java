...
public class Heart2 {
    ...
    public Heart2(final World world, final float _x, final float _y){  //<<

        this.x = _x; //<<
        this.y = _y; //<<
        this.world = world;

        sprite = SpriteLoader.getSprite("images/heart.json");
    ...
    public void update(int delta){
        ...
        if(e > 150) {
            ...
            switch (state){
                ...
                case DIE: offset = 7; break;
                case RIGHT: offset = 14; break;
