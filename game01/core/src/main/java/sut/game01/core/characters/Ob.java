...
public class Ob {
    ...
    private int e = 0;
    private int offset = 8; //chang Here
    ...
    public Ob(final World world, final float _x, final float _y, int index,int r){  //<<
        ...
        sprite = SpriteLoader.getSprite("images/ob.json");
    ...
    public void update(int delta){
        ...
        if(e > 150) {
            ...
            switch (state){
                ...
                case GREEN: offset = 4; break;
                case BOOM: offset = 8; break;
    ...
    private Body initPhysicsBody(World world, float x, float y){  //<< Start
        ...
        if(_index == 1) {
            GameplayScreen.bodies.put(body, "OB" );
            GameplayScreen.bodiesB.put(body, "OB");
            shape.setAsBox(30 * GameplayScreen.M_PER_PIXEL / 2, sprite.layer().height() * GameplayScreen.M_PER_PIXEL / 2);
        }else if(_index == 2){
            GameplayScreen2.bodies.put(body, "OB" );
            GameplayScreen2.bodiesB.put(body, "OB");
            shape.setAsBox(30 * GameplayScreen2.M_PER_PIXEL / 2, sprite.layer().height() * GameplayScreen2.M_PER_PIXEL / 2);
        }else if(_index == 3){
            GameplayScreen3.bodies.put(body, "OB");
            GameplayScreen3.bodiesB.put(body, "OB");
